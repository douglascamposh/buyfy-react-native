import { STORES_FETCH_ADMIN_SUCCESS, STORE_CREATE_SUCCESS, STORE_UPDATE_SUCCESS, STORE_DISABLE_ENABLE_SUCCESS, STORES_BY_USER_FETCH_PENDING } from '../actions/types';
...
export default (state = INITIAL_STATE, action) => {
  switch (action.type) {
    ...
    case STORES_BY_USER_FETCH_PENDING:
      return { 
        ...state, 
        pending: true 
      };
